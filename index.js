...
var graph = {
  labels: ["2015","2016","2017","2018","2019"], // 12
  datasets: [
    {
      ...
      pointHighlightStroke: "#c2ebff",
      data: [3.39, 3.20, 3.13, 3.80, 5.32]  // 12	
    }
  ]
};

//table
var div1 = $('.dataTables_scrollBody');
var div2 = $('.dataTables_scrollHead, .dataTables_scrollFoot');
